    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="user_regist.action" method="post" novalidate="novalidate" onsubmit="checkForm()">
                    <table>
                        <tbody><tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" ><img id="checkImg" class="captchaImage" src="checkImg.action" onclick="change()" title="点击更换验证码"><s:actionerror />
										</span>
                            </td>
                        </tr>
                        <tr>
